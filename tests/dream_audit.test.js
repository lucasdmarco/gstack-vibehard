...
test("audit: classifica claims, é determinístico e read-only (todas têm status)", async () => {
  ...
  for (const id of ["runtime-supervisor", "secrets-broker", "runtime-manifest", "package-manager", "full-contract", "agent-factory", "agentshield", "adapter-matrix", "task-loop", "qa-multi-lens", "vfa-provenance", "challenge-response"]) {
