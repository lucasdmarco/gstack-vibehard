...
Um instalador que guia você pela configuração de hooks Python, skills, template fullstack, design system taste-skill, e 20 agentes especialistas — tudo com Quality Gate obrigatório.
...
| **Agentes** | 20 especialistas (orchestrator, frontend, backend, security, QA, etc.) com QG Gate obrigatório antes de cada entrega |
| **MCP** | Fallow (codebase intelligence) + Supabase (opcional) |
