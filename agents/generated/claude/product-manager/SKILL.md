...
> Gerado automaticamente por scripts/scripts/build_agents.js. Nao edite este arquivo manualmente; edite core/, knowledge/ ou agents/agents/product-manager.md.
