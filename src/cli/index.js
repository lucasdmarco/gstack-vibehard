...
export const COMMANDS = [
  ...
  { name: "verify", group: "common", desc: "Delivery gates por arquétipo", usage: "gstack_vibehard verify [--quick] [--profile full|release | --release] [--tier <t>] [--harness <id>] [--changed-files] [--agentshield] [--dry-run] [--json]" },
  ...
  { name: "visual", group: "advanced", desc: "Gate visual EXECUTADO: navegador/screenshot/console/rede/a11y como evidência", usage: "gstack_vibehard visual check --url <endereço> [--run <id>] [--json] · visual hooks install|status|uninstall [--yes] [--json]" },
  ...
  { name: "plan", group: "advanced", desc: "Gerar plano guiado determinístico", usage: "gstack_vibehard plan \"<objetivo>\" [--json --dry-run --recipe <id>] · plan run <id> [--yes] · plan status|explain <id>" },
