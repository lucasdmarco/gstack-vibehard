...
const COMMANDS = [
  ...
  { name: "doctor", group: "common", desc: "Diagnosticar ambiente", usage: "gstack_vibehard doctor [--json [--strict]] [--impact] [--supply-chain] [--install-integrity] [--repair-manifest [--yes]] [--package-manager [--fix]]" },
