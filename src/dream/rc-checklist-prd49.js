...
export const PRD49_RC_ITEMS = Object.freeze([
  ...
  { id: "P1.1", tier: "P1", sprint: "S49.1/S51.7.5", version: "5.89.0", status: "delivered", title: "Bridge canônico de contexto de design — PRODUCT.md/DESIGN.md/.impeccable/design.json com sourceHash determinístico; PRD51 S51.7.5 fechou o wiring: `visual context sync` persiste de verdade (edição humana NUNCA sobrescrita) e o design gate consome o drift como sinal advisory", proof: "tests/design_context_sync.test.js" },
